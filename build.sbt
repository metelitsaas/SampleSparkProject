...
libraryDependencies ++= Seq(
    ...
    "org.apache.spark" %% "spark-core" % "2.3.0" % Test classifier "test-sources",
    "org.apache.spark" %% "spark-sql" % "2.3.0" % Provided,
    "org.apache.spark" %% "spark-sql" % "2.3.0" % Test classifier "tests",
    "org.apache.spark" %% "spark-sql" % "2.3.0" % Test classifier "test-sources",
    "org.apache.spark" %% "spark-hive" % "2.3.0" % Provided,
    "org.apache.spark" %% "spark-hive" % "2.3.0" % Test classifier "tests",
    "org.apache.spark" %% "spark-hive" % "2.3.0" % Test classifier "test-sources",
    "org.apache.spark" %% "spark-catalyst" % "2.3.0" % Test classifier "tests",
    "org.apache.spark" %% "spark-catalyst" % "2.3.0" % Test classifier "test-sources",
